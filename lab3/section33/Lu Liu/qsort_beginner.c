...
//  - 'low' is the starting index of partition.
//  - 'high' is the ending index of partition.
// Output: The index where the elemnet is put after the partition.
int partition(int arr[], int low, int high) {
    int pivot = arr[high]; // Choose the last element of the array as pivot
    int i = low; // place the next smaller element than pivot 
    ...
    for (int j = low; j < high; j++) {
        ...
        if (arr[j] < pivot) {
            ...
            arr[j] = arr[i];
            arr[i] = temp;
            i++; // Increasing i for the next smaller element
        }
    }
    ...
    return i; // Return the index where the pivot element is now placed
}

// Name: quickSort
// Input(s):
//  - 'arr' is a pointer to an array of integers.
//  - 'low' is the starting index of the segment of the array to be sorted.
//  - 'high' is the ending index of the segment of the array to be sorted.
// Output: No return value. The array is sorted.
