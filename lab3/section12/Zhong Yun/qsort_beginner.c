...
void quickSort(int arr[], int low, int high){
    //Set base case for recursion: low pivot meets high pivot
    if(low < high)
    {
        int t = partition(arr, low, high);
        //Recursivly do sort on left part of the array
        quickSort(arr, low, t-1);
        //Recursivly do sort on right part of the array
...
void sortIntegers(int* array, unsigned int size) {
    ...
    // Start the sort with two pointers (pivots) one at the first element, one at the last element
